...
const abiAtomicSwapERC20 = require('./artifacts/contracts/AtomicSwapERC20.sol/AtomicSwapERC20.json');
const abiTokenERC20 = require('./artifacts/contracts/TestERC20.sol/TestERC20.json');
const config = require('./config/development.json');

let deployer_address = config.Network.interface.wallet_address;
let privateKey = config.Network.interface.wallet_privateKey;
let withdrawTraderAddress = config.Network.interface.withdrawTraderAddress;
let trader_privateKey = config.Network.interface.trader_privateKey;
...
let AtomicSwapERC20Address = config.Network.interface.atomic_swaperc20_address;
let TestERC20Address = config.Network.interface.testerc20_address;
